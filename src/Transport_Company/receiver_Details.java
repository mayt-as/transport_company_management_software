...
public class receiver_Details extends JDialog {
	...
	public static void main(String[] args) {
		try {
			receiver_Details dialog = new receiver_Details(0, null, null);
	 ...
	 */
	public receiver_Details(int dispatched, String consignmentid, String receiverid)
			throws ClassNotFoundException, SQLException {
		setTitle("Enter Receiver Details");
						...
						try {
							...
							if (dispatched == 1)
								JOptionPane.showMessageDialog(null,
										"Consignment " + consignmentid + " is successfully dispatched");
							else
								JOptionPane.showMessageDialog(null,
										"Consignment " + consignmentid + " is waiting as no truck is available");
							dispose();
						} catch (Exception e) {
							e.printStackTrace();
						}
