...
public class StartFrame extends JFrame {
	...
	public StartFrame() throws IOException {
		image = ImageIO.read(getClass().getResource("/tccs_logo.png"));
		setIconImage(image);
		setTitle("Transport Company Computerization Software");
		setResizable(false);
		URL url = getClass().getResource("/tccs_logo.png");
		...
		lblNewLabel.setBounds(0, 0, getWidth() / 2, (getHeight() * 4) / 5);
		...
		btnNewButton.setBounds(290, 70, 123, 63);
		...
		btnNewButton_1.setBounds(290, 150, 123, 63);
