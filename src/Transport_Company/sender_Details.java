...
public class sender_Details extends JDialog {
	...
	public static void main(String[] args) {
		try {
			sender_Details dialog = new sender_Details(0, null, null, null);
	 ...
	 */
	public sender_Details(int dispatched, String consignmentid, String senderid, String receiverid)
